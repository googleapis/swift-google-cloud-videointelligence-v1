...
extension Clients {
  final class VideoIntelligenceServiceRetry: VideoIntelligenceServiceStub {
    let inner: any VideoIntelligenceServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any VideoIntelligenceServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
