...
extension Clients {
  ...
  class VideoIntelligenceServiceTransport: VideoIntelligenceServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://videointelligence.googleapis.com")
    }
