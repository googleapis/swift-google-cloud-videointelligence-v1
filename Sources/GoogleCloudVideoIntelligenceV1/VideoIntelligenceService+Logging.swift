...
extension Clients {
  final class VideoIntelligenceServiceLogging: VideoIntelligenceServiceStub {
    let inner: any VideoIntelligenceServiceStub
    let logger: Logger

    public init(_ inner: any VideoIntelligenceServiceStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-videointelligence-v1"
      logger[metadataKey: "gcp.client.service"] = "videointelligence"
      logger[metadataKey: "gcp.experimental.swift.client"] = "VideoIntelligenceService"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func annotateVideo(
      ...
      try await self._intercept(
        ...
        name: "annotateVideo",
        action: {
          (r: AnnotateVideoRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.annotateVideo(request: r, options: o)
        })
    }
